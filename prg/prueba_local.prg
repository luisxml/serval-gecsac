...
SET SYSMENU OFF
PUBLIC lcAppDir,Vgc_almatrab,Vgc_usuario,nres,Vln_romana,Vpn_bascula,Vgn_romana,Vpc_server 
...
PUBLIC Vgn_bascula,Vgc_CERTIFICACION_INEA, VGC_VERSION,Vcl_conex,VPC_llave,Vgc_caja,Vgc_impresora,Vgc_impresora2,Vgc_barras
Vgc_barras =0  
*SET STEP ON
...
cnControladorArch = FOPEN("config2.txt")
